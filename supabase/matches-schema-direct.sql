-- ============================================
-- MATCH REGISTRATION SYSTEM - SQL TO EXECUTE
-- ============================================
...
-- Note: These policies check auth.jwt() which won't work with Clerk auth
-- but are kept for consistency. Authentication is handled in API routes.
...
-- Matches are publicly readable (this works for public access)
